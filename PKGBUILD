...
license=('MIT')
depends=('glibc')
source=("https://github.com/godotengine/godot-builds/releases/download/4.6-beta3/Godot_v4.6-beta3_linux.x86_64.zip"
        "godot-next.desktop")
...
package() {
    ...
    bsdtar -xf Godot_v4.6-beta3_linux.x86_64.zip -C "$pkgdir/opt/godot-next"
    
    # Symlink to /usr/bin for convenience
    install -dm755 "$pkgdir/usr/bin"
    ln -s /opt/godot-next/Godot_v4.6-beta3_linux.x86_64 "$pkgdir/usr/bin/godot-next"
